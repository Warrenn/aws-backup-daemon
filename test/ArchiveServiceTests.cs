...
//         var startedRun = await sut.StartNewArchiveRun(ref new RunRequest(runId, "/p", "* * * * *"), CancellationToken.None);
//
...
//
//         var run = await sut.StartNewArchiveRun(ref req, CancellationToken.None);
...
//         await sut.StartNewArchiveRun(ref req, CancellationToken.None);
//
//         // New file → true
