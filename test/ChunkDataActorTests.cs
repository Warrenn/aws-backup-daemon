...
//     private readonly Mock<ICountDownEvent> _latch = new();
//
...
//
//         _chunksMediator.Setup(m => m.GetChunkRequests(It.IsAny<CancellationToken>())).Returns(channel.Reader.ReadAllAsync());
//
...
//             x => x.RecordChunkUpload("run-3", "file3.txt", chunk.ChunkHashId, It.IsAny<CancellationToken>()), Times.Once);
//     }
//
//     [Fact]
