...
docker cp temp:/app/aws-backup/publish ./linux-output
docker cp temp:/app/aws-backup-commands/publish ./linux-output
docker cp temp:/app/cert-gen/publish ./linux-output
docker rm temp
docker system prune -af